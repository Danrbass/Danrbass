...
<div display = flex align = center justify-content = space-between margin= 2.5rem padding = 2.5rem>
    ...
    <img width = 6.0% padding = 5rem margin = 5rem  src="https://seeklogo.com/images/P/power-bi-icon-logo-E1B451ED39-seeklogo.com.png" >
